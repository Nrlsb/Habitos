...
const Planning = () => {
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 md:pb-0 px-4 pt-safe flex flex-col min-h-0" style={{ paddingBottom: 'calc(4.5rem + env(safe-area-inset-bottom))' }}>
