...
const Planning = () => {
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 md:pb-0 px-4 pt-safe overflow-y-auto max-h-[calc(100vh-220px)]" style={{ paddingBottom: 'calc(4.5rem + env(safe-area-inset-bottom))' }}>
